  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        className="w-full h-12 pl-11 pr-12 bg-zinc-900 border border-zinc-800 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-[#8b5ef4] transition-all"
      />
