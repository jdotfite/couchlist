  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        className="w-full h-12 pl-11 pr-12 bg-surface-2 rounded-lg text-white placeholder-text-muted focus:outline-none focus:ring-2 focus:ring-brand-primary transition-all"
      />
