...
export default function AddRowCard({ onClick }: AddRowCardProps) {
  return (
    <button
      onClick={onClick}
      className="w-full py-3 border-2 border-dashed border-zinc-700 hover:border-brand-primary rounded-xl flex items-center justify-center gap-2 text-gray-400 hover:text-brand-primary transition group"
    >
